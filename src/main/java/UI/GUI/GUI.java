...
public class GUI {
  ...
  private JPanel createMenuPanel() {
    ...
    addStyledButton(
      menuPanel,
      "src/main/ressources/buttons/gamebuttons/start.png",
      e -> displayRulesPanel()
    );
    addStyledButton(
      menuPanel,
      "src/main/ressources/buttons/gamebuttons/settings.png",
      e -> showCard("Options")
    );
    addStyledButton(
      menuPanel,
      "src/main/ressources/buttons/gamebuttons/credits.png",
      e -> showCard("Crédits")
    );
    addStyledButton(
      menuPanel,
      "src/main/ressources/buttons/gamebuttons/quit.png",
      e -> System.exit(0)
    );
  ...
  public JPanel createMainPanel() {
    return new JPanel(new BorderLayout()) { // on créer un panel general pour mettre une image en fond pour le
      ...
      protected void paintComponent(Graphics g) {
        ...
        try {
          Image backgroundImage = ImageIO.read(
            new File("src/main/ressources/menu/main_menu_usable.jpg")
          );
  ...
  private JPanel createCreditsPanel() {
    JPanel creditsPanel = new JPanel() {
      ...
      protected void paintComponent(Graphics g) {
        ...
        try {
          Image backgroundImage = ImageIO.read(
            new File("src/main/ressources/menu/credits.jpg")
          );
          g.drawImage(backgroundImage, 0, 0, getWidth(), getHeight(), this);
        } catch (IOException e) {
          e.printStackTrace();
    ...
    addStyledButton(
      creditsPanel,
      "src/main/ressources/buttons/gamebuttons/back.png",
      e -> showCard("Menu")
    );
  ...
  private JPanel createRulesPanel() {
    JPanel rulesPanel = new JPanel(new BorderLayout()) {
      ...
      protected void paintComponent(Graphics g) {
        ...
        try {
          Image backgroundImage = ImageIO.read(
            new File("src/main/ressources/menu/rules.jpg")
          );
          g.drawImage(backgroundImage, 0, 0, getWidth(), getHeight(), this);
        } catch (IOException e) {
          e.printStackTrace();
    ...
    try {
      Image img = ImageIO.read(
        new File("src/main/ressources/buttons/gamebuttons/logo.png")
      );
      ImageIcon icon = new ImageIcon(
        img.getScaledInstance(120, 120, Image.SCALE_SMOOTH)
      );
  ...
  private JPanel createOptionsPanel() {
    JPanel optionsPanel = new JPanel() {
      ...
      protected void paintComponent(Graphics g) {
        ...
        try {
          Image backgroundImage = ImageIO.read(
            new File("src/main/ressources/menu/settings.jpg")
          );
          g.drawImage(backgroundImage, 0, 0, getWidth(), getHeight(), this);
        } catch (IOException e) {
          e.printStackTrace();
