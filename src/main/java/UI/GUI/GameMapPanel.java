...
public class GameMapPanel extends JPanel {
  ...
  private void initializeImages() {
    try {
      Image tntTower = ImageIO.read(
        new File("src/main/ressources/towers/bullettower.png")
      );
      Image fightTower = ImageIO.read(
        new File("src/main/ressources/towers/fighttower.png")
      );
      Image sniperTower = ImageIO.read(
        new File("src/main/ressources/towers/snipertower.png")
      );
      Image nukeTower = ImageIO.read(
        new File("src/main/ressources/towers/nucleartower.png")
      );
      Image speedTower = ImageIO.read(
        new File("src/main/ressources/towers/speedtower.png")
      );
      Image bulletTower = ImageIO.read(
        new File("src/main/ressources/towers/bullettower.png")
      );
      ...
      Image enemyDreth = ImageIO.read(
        new File("src/main/ressources/mobs/dreth.png")
      );
      Image enemyFyron = ImageIO.read(
        new File("src/main/ressources/mobs/fyron.png")
      );
      Image enemyGazer = ImageIO.read(
        new File("src/main/ressources/mobs/gazer.png")
      );
      Image enemyKyron = ImageIO.read(
        new File("src/main/ressources/mobs/kryon.png")
      );
      Image enemyLiche = ImageIO.read(
        new File("src/main/ressources/mobs/liche.png")
      );
      Image enemyZorch = ImageIO.read(
        new File("src/main/ressources/mobs/zorch.png")
      );
  ...
  public void placeTowerAtReleasedPosition(int x, int y) {
    if (isPlacingTower && towerToPlace != null) {
      ...
      if (
        cellX >= 0 &&
        cellX < gameMap.getCols() &&
        cellY >= 0 &&
        cellY < gameMap.getRows()
      ) {
  ...
  protected void paintComponent(Graphics g) {
    ...
    for (Tower t : gameMap.listOfAllTowers()) {
      ...
      if (t instanceof FigthTower) g.drawImage(
        towerImages.get("fightTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
      ...
      if (t instanceof BulletTower) g.drawImage(
        towerImages.get("bulletTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
      ...
      if (t instanceof NukeTower) g.drawImage(
        towerImages.get("nukeTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
      ...
      if (t instanceof SniperTower) g.drawImage(
        towerImages.get("sniperTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
      ...
      if (t instanceof SpeedTower) g.drawImage(
        towerImages.get("speedTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
      ...
      if (t instanceof TntTower) g.drawImage(
        towerImages.get("tntTower"),
        towerX,
        towerY,
        cellWidth,
        cellHeight,
    ...
    for (Enemy enemy : gameMap.listOfAllEnemies()) {
      ...
      if (enemy instanceof Dreth) g.drawImage(
        enemiesImages.get("enemyDreth"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
      ...
      if (enemy instanceof Zorch) g.drawImage(
        enemiesImages.get("enemyZorch"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
      ...
      if (enemy instanceof Fyron) g.drawImage(
        enemiesImages.get("enemyFyron"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
      ...
      if (enemy instanceof Gazer) g.drawImage(
        enemiesImages.get("enemyGazer"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
      ...
      if (enemy instanceof Kryon) g.drawImage(
        enemiesImages.get("enemyKryon"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
      ...
      if (enemy instanceof Liche) g.drawImage(
        enemiesImages.get("enemyLiche"),
        enemyX,
        enemyY,
        cellWidth,
        cellHeight,
    ...
    if (highlightedCellX != -1 && highlightedCellY != -1) {
      ...
      g.fillRect(
        highlightedCellX * cellWidth,
        highlightedCellY * cellHeight,
        cellWidth,
        cellHeight
      );
    }
