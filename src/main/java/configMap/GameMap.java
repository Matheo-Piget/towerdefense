        ...
        for (int i = 0; i < tiles.length; i++) {
            ...
            for (int j = 0; j < tiles[0].length; j++) {
                ...
                if (tiles[i][j].getElement() instanceof Enemy)
                    enemys.add((Enemy) tiles[i][j].getElement()); // des que l'on a un enmis ou l'ajoute dasn la liste
        ...
        for (int i = 0; i < tiles.length; i++) {
            ...
            for (int j = 0; j < tiles[0].length; j++) {
                ...
                if (tiles[i][j].getElement() instanceof Tower)
                    towers.add((Tower) tiles[i][j].getElement()); // des que l'on a une tours ou l'ajoute dasn la liste
